                        ...
                        (0..pub_params.challenge_count)
                            ...
                            .fold(
                                ...
                                |(mut inclusion_proofs, mut faults), n| {
                                    ...
                                    match proof {
                                        Ok(proof) => {
                                            //  let res = proof.validate(challenged_leaf as usize);
                                            //  trace!("!!!wcl validate result={}", res);
						    ...
						    //info!("eddy_log_validate1_sector_id={},challenged_leaf_start={},proof={:?}",sector_id,challenged_leaf,proof);
